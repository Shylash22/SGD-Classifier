...
1. Create the dataset with **Hours Studied, Previous Score, Internship, and Placement**, and split it into **features (X)** and **target (y)**.
2. Perform **train–test split** and apply **StandardScaler** for feature scaling.
3. Train the **SGDClassifier with logistic loss (logistic regression)** using the training data.
4. Predict placement results, evaluate using **confusion matrix and accuracy**, and test prediction for a **new student**.
...
## Output:
<img width="530" height="383" alt="image" src="https://github.com/user-attachments/assets/4154acc7-01ec-47b2-a74c-4c67ee8b37a6" />
